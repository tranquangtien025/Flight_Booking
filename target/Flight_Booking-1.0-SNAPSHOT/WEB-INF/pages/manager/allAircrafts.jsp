                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item active" href="">All Aircrafts</a></li>
                                </ol>
                            </div>
                        </div>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="aircraft" items="${aircrafts}">
                                                                <tr class="odd gradeX">                                                                
                                                                    ...
                                                                    <td class="center">                
                                                                        <img src="<c:url 
                                                                             value="/resources-management/img/${aircraftService.findFirstImageOfAircraft(aircraft.id)}"/>" 
                                                                             width="100px" height="100px"/>                                                                         
                                                                    </td>
                                                                    <td class="center">${aircraft.status}</td>
                                                                    <td class="center">
                                                                        <a href="<c:url value="/manager/editAircraft/${aircraft.id}"/>" class="btn btn-tbl-edit btn-xs">
