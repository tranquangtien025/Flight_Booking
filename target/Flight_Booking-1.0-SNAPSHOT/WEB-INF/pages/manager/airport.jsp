                                ...
                                <li class="nav-item active">
                                    ...
                                    <c:if test="${action == 'edit'}">
                                        <ul class="sub-menu">
                                            ...
                                            <li class="nav-item active">
                                                <a href="<c:url value="/manager/editAirport/${airport.id}"/>" class="nav-link ">
                                                    <span class="title">Edit Airport Details</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </c:if>                                    
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <c:if test="${action == 'add'}">
                                        <div class="page-title">Add Airport Details</div>
                                    </c:if>
                                    <c:if test="${action == 'edit'}">
                                        <div class="page-title">Edit Airport Details</div>
                                    </c:if>                                                   
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <c:if test="${action == 'add'}">
                                        <li><a class="parent-item active" href="">Add Airport Details</a></li>
                                        </c:if>
                                        <c:if test="${action == 'edit'}">
                                        <li><a class="parent-item active" href="">Edit Airport Details</a></li>
                                        </c:if>                                    
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="card-body">
                                        <mvc:form id="airportForm" action="${pageContext.request.contextPath}/manager/airportResult/${action}"
                                                  method="post" 
                                            ...
                                            <c:if test="${action == 'edit'}">
                                                <input type="text" name="id" 
                                                       value="${airport.id}" hidden />
                                            </c:if>

                                                <div class="row">
                                            <div class="col-lg-9 p-t-20"> 
                                                <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <select id="city" name="city.id" class="mdl-textfield__input">
                                                        <c:forEach var="city" items="${cities}">
                                                            <c:if test="${airport.city.id == city.id}">
                                            ...
                                            <div class="col-lg-9 p-t-20"> 
                                                <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <input class = "mdl-textfield__input" type = "text" id="name"
                                                           value="${airport.name}" id = "txtFirstName" name="name"
                                                           placeholder="Ha Noi (HAN), Vietnam">
                                                ...
                                                <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <select id="" name="status" class="mdl-textfield__input">
                                                        <c:forEach var="status" items="${statuses}">
                                                            <c:if test="${airport.status == status}">
                                                ...
                                                <c:forEach items="${airport.images}" var="image">
                                                    <div class="col-sm-3 p-t-20">
                                                        ...
                                                        <button onclick="location.href = '<c:url 
                                                                    value="/manager/deleteImageOfAirport/${airport.id}/${image.id}"/>'"
                                        ...
                                        <div class="row" style="padding-top: 30px">
                                            <div class="col-lg-12 p-t-20 text-center"> 
                                                <button form="airportForm" type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink">Submit</button>
                                                <button onclick="location.href = '<c:url value="/manager/allAirports"/>'"
