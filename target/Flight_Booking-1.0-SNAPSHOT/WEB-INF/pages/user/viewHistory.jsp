                                                        ...
                                                        <tbody>
                                                            <c:forEach var="booking" items="${bookings}">
                                                                <tr class="odd gradeX">                                                                
                                                                    ...
                                                                    <td class="center">
                                                                        <a href="<c:url value="/user/bookingDetails/${booking.id}"/>" class="btn btn-tbl-edit btn-xs">
