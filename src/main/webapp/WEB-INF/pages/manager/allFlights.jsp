                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item active" href="">All Flights</a></li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <div class="card-body ">
                                                <div class="table-scrollable">
                                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                        <thead>
                                                            <tr>
                                                                <th class="center"> Flight Number </th>
                                                                <th class="center"> Flight Route </th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="flight" items="${flights}">
                                                                <tr class="odd gradeX">                                                                
                                                                    <td class="center">${flight.flightNumber}</td>
                                                                    <td class="center">${flight.flightRoute.departure.name} - ${flight.flightRoute.destination.name}</td>
                                                                    <td class="center">
                                                                        <fmt:formatDate pattern="dd/MM/yyyy" value="${flight.departureDate}"/>
                                                                    </td>
                                                                    <td class="center">
                                                                        <fmt:formatDate pattern="dd/MM/yyyy" value="${flight.arrivalDate}"/>
                                                                    </td>
                                                                    <td class="center">${flight.departureTime}</td>
                                                                    <td class="center">${flight.arrivalTime}</td>
                                                                    <td class="center">${flight.aircraft.name}</td>
                                                                    <td class="center">${flight.operation.name}</td>
                                                                    <td class="center">${flight.status}</td>
                                                                    <td class="center">
                                                                        <a href="<c:url value="/manager/editFlight/${flight.id}"/>" class="btn btn-tbl-edit btn-xs">
