                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item active" href="">All Flight Routes</a></li>
                                </ol>
                            </div>
                        </div>
                                                    ...
                                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="center"> Economy Price </th>
                                                                <th class="center"> Premium Economy Price </th>
                                                                <th class="center"> Business Price </th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="flightRoute" items="${flightRoutes}">
                                                                <tr class="odd gradeX">                                                                
                                                                    <td class="center">${flightRoute.departure.name}</td>
                                                                    <td class="center">${flightRoute.destination.name}</td>
                                                                    <td class="center">
                                                                        ${flightRoute.distance} km
                                                                    </td>
                                                                    <td class="center">${flightRoute.duration}</td>
                                                                    <td class="center">
                                                                        <fmt:setLocale value="vi_VN" scope="session"/>
                                                                        <fmt:formatNumber type="currency" currencySymbol="VND"
                                                                                          value="${flightRoute.economyPrice}"/>                                                                        
                                                                    </td>
                                                                    <td class="center">
                                                                        <fmt:setLocale value="vi_VN" scope="session"/>
                                                                        <fmt:formatNumber type="currency" currencySymbol="VND"
                                                                                          value="${flightRoute.premiumEconomyPrice}"/>                                                                        
                                                                    </td>
                                                                    <td class="center">
                                                                        <fmt:setLocale value="vi_VN" scope="session"/>
                                                                        <fmt:formatNumber type="currency" currencySymbol="VND"
                                                                                          value="${flightRoute.businessPrice}"/>                                                                        
                                                                    </td>
                                                                    <td class="center">${flightRoute.status}</td>
                                                                    <td class="center">
                                                                        <a href="<c:url value="/manager/editFlightRoute/${flightRoute.id}"/>" class="btn btn-tbl-edit btn-xs">
