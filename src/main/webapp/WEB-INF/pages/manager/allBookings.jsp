...
<html lang="en">
    ...
    <head>
        ...
        <script src="<c:url value="https://cdn.datatables.net/1.10.9/js/jquery.dataTables.js"/>" ></script>
        <script>
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item active" href="">All Bookings</a></li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        <div class="card-box">
                                            <div class="card-head noprint">
                                                ...
                                                <ul class = "mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                                                    ...
                                                    <a href="<c:url value="/manager/bookings/export/excel"/>">
                                                        <li class = "mdl-menu__item">
                                                            <i class="material-icons">book</i>Export to Excel
                                                        </li>       
                                                    </a>
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                <div class="row noprint" style="padding-bottom: 10px">
                                                    <div class="col-md-8 col-lg-8">
                                                        <form action="${pageContext.request.contextPath}/manager/searchByDate"
...
<!--                                                        <form action="${pageContext.request.contextPath}/manager/searchByBookingNumber"
                                                              method="get" class="form-inline float-right">
                                                            <div class="form-group">
                                                                <input type="text" name="bookingNumber" value="${bookingNumber}"
                                                                       class="form-control" placeholder="Search Character"/>
                                                                <input type="submit" value="Search"
                                                                       class="btn bg-b-yellow" />&nbsp;
                                                            </div>
                                                        </form>-->
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table table-hover table-checkable order-column full-width"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="center noprint"> Action </th>
                                                            </tr>
                                                        </thead>
                                                        <tfoot class="noprint">
                                                            <tr>
                                                        ...
                                                        <tbody>            
                                                            <c:if test="${bookings != null || fn:length(bookings)>0}">
                                                                <c:forEach var="booking" items="${bookings}">
                                                                    <tr class="odd gradeX">                                                                
                                                                        <td class="center">
                                                                            <fmt:formatDate pattern="dd/MM/yyyy hh:mm" value="${booking.bookingDate}"/>                                                                        
                                                                        </td>
                                                                        ...
                                                                        <td class="center noprint">
                                                                            <a href="<c:url value="/manager/bookingDetails/${booking.id}"/>" class="btn btn-tbl-edit btn-xs">
                                                                                <i class="fa fa-address-book-o"></i>
                                                                            </a>
                                                                            <a href="<c:url value="/manager/deleteBooking/${booking.id}"/>" class="btn btn-tbl-edit btn-xs">
