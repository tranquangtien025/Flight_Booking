                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item active" href="">All Users</a></li>
                                </ol>
                            </div>
                        </div>
                                                            ...
                                                            <c:forEach var="user" items="${users}">
                                                                <tr class="odd gradeX">                                                                
                                                                    ...
                                                                    <c:if test="${user.status == 'ACTIVE'}">
                                                                        <td class="center"><p class="btn btn-circle btn-success">${user.status}</p></td>
                                                                        </c:if>
                                                                        <c:if test="${user.status == 'UNACTIVE'}">
                                                                        <td class="center"><p class="btn btn-circle btn-warning">${user.status}</p></td>
                                                                        </c:if>
                                                                        <c:if test="${user.status == 'BLOCK'}">
                                                                        <td class="center"><p class="btn btn-circle btn-danger">${user.status}</p></td>
                                                                        </c:if>
                                                                    <td class="center">
                                                                        <c:forEach items="${userService.getListRolesOfUser(user.id)}" var="role">
                                                                            ${role}<br>
                                                                        </c:forEach>
                                                                    </td>
                                                                    <td class="center">
                                                                        <a href="<c:url value="/admin/editUser/${user.id}"/>" class="btn btn-tbl-edit btn-xs">
